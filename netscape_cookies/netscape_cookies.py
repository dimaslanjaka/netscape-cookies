...
def save_to_file(cookies: List[Cookie], cookieFile: str):
    ...
    with open(cookieFile, "w") as file:
        ...
        file.write("# This file was generated by a Python script\n")
        file.write("# https://www.netscape.com/\n")
        file.write("# HttpOnly cookies are not supported by this file format.\n\n")
